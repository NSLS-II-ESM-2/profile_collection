...
import sys
# from suitcase import hdf5  TODO: Fix import in >=py3.10
...
def filter_fields(headers, unwanted_fields):
    ...
    return whitelist
# =====================================================================================
# TODO: Remove above when suitcase supports >=py3.10
...
def ESM_export(scan_ID,filename):
        ...
        # TODO: Revert when suitcase version is fixed
        #hdf5.export(hdr,filestring)
        export(hdr, filestring)
